...
<?php
	...
	while($A = mysqli_fetch_array($query_articles)){
		...
		echo '<img style="border-bottom:4px solid #f4f4f4;" src="img/articles_imgs/'.$A['blog_img1'].'" alt="" />';
		echo '</a>';
...
<div id="6open" class="large-12 columns" style="margin:0px; padding:0px;">
<hr />	

	<div id="7open" class="large-4 columns" style="margin:0px; padding:0px;">
		<?php
	if(!empty($_SESSION['cur_login'])){	
	echo'<a href="xwriter.php">';
	echo'<i class="fa fa-plus-square-o fa-lg "></i><span class="addNewBP">NEW</span>';
	echo'</a>';
	}
	?>
	</div><!-- div id 7Close -->	
